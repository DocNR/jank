...
import { LocalizedLanguageNames, setLanguage as setI18nLanguage, TLanguage } from '@/i18n'
...
const GeneralSettingsPage = forwardRef(({ index }: { index?: number }, ref) => {
  ...
  const handleLanguageChange = (value: TLanguage) => {
    // Loads the locale's lazy chunk before switching so strings don't flash in
    // English first.
