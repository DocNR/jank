export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'Mostra agli altri che questo è stato inviato tramite {{appName}}',
    ...
    Reactions: 'Reazioni',
    Zaps: 'Zaps',
    'Enjoying {{appName}}?': 'Ti sta piacendo {{appName}}?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'La tua donazione mi aiuta a mantenere {{appName}} e a migliorarlo! 😊',
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} è un client focalizzato sulla navigazione dei relay. Inizia esplorando relay interessanti o effettua il login per visualizzare il tuo feed di following.',
    'Explore Relays': 'Esplora Relay',
    'Choose a feed': 'Scegli un feed',
    'and {{x}} others': 'e altri {{x}}',
    selfZapWarning:
      '{{appName}} non è responsabile di ciò che accade se zappi te stesso. Procedi a tuo rischio e pericolo. 😉⚡',
