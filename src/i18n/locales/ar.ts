export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}': 'عرض أن هذه الرسالة أُرسلت عبر {{appName}}',
    ...
    Reactions: 'التفاعلات',
    Zaps: 'Zaps',
    'Enjoying {{appName}}?': 'هل تستمتع بـ {{appName}}؟',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'تبرعك يساعد في صيانة {{appName}} وتحسينه! 😊',
    ...
    'Welcome to {{appName}}': 'مرحبًا بك في {{appName}}',
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} هو عميل يركز على تصفح المرحلات. ابدأ باستكشاف المرحلات المثيرة للاهتمام أو قم بتسجيل الدخول لعرض خلاصتك.',
    'Explore Relays': 'استكشف المرحلات',
    'Choose a feed': 'اختر خلاصة',
    'and {{x}} others': 'و {{x}} آخرون',
    selfZapWarning:
      '{{appName}} غير مسؤولة عما يحدث إذا أرسلت zap لنفسك. تابع على مسؤوليتك الخاصة. 😉⚡',
