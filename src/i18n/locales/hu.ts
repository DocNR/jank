export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'Mutasd meg másoknak, hogy {{appName}}-lel küldted',
    ...
    Reactions: 'Reakciók',
    Zaps: 'Zap-ok',
    'Enjoying {{appName}}?': 'Tetszik a {{appName}}?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'Az adományok segítenek a {{appName}} fenntartásában és továbbfejlesztésében! 😊',
    ...
    'Welcome to {{appName}}': 'Isten hozott',
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} egy kliens, amivel könnyen böngészhetsz csomópontokat. Kezdd az érdekes csomópontok felderítésével, vagy lépj be, hogy a követettek posztjait megnézd.',
    ...
    'Welcome to {{appName}}!': 'Üdvözlünk a {{appName}}-ban!',
