export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'به دیگران نشان دهید که از طریق {{appName}} ارسال شده',
    ...
    Reactions: 'واکنش‌ها',
    Zaps: 'زپ‌ها',
    'Enjoying {{appName}}?': 'از {{appName}} لذت می‌برید؟',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'کمک مالی شما به من در نگهداری {{appName}} و بهتر کردن آن کمک می‌کند! 😊',
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} یک کلاینت متمرکز بر مرور رله‌هاست. با کاوش در رله‌های جالب شروع کنید یا وارد شوید تا فید دنبال‌کننده‌های خود را مشاهده کنید.',
    'Explore Relays': 'کاوش در رله‌ها',
    'Choose a feed': 'یک فید انتخاب کنید',
    'and {{x}} others': 'و {{x}} دیگر',
    selfZapWarning:
      '{{appName}} مسئولیتی در قبال اتفاقاتی که در صورت ارسال zap به خودتان می‌افتد ندارد. با مسئولیت خود ادامه دهید. 😉⚡',
