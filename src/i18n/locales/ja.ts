export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}': 'これが{{appName}}経由で送信されたことを表示',
    ...
    Reactions: '反応',
    Zaps: 'Zap',
    'Enjoying {{appName}}?': '{{appName}}をお楽しみですか？',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'あなたの寄付は{{appName}}の維持と改善に役立ちます！ 😊',
    ...
    'Welcome to {{appName}}': '{{appName}}へようこそ',
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}}はリレーを閲覧することに焦点を当てたクライアントです。興味深いリレーを探索するか、ログインしてフォロー中のフィードを表示してください。',
    'Explore Relays': 'リレーを探索',
    'Choose a feed': 'フィードを選択',
    'and {{x}} others': 'および他{{x}}人',
    selfZapWarning:
      '{{appName}} は、あなたが自分自身にザップした場合の結果について責任を負いません。自己責任で続行してください。😉⚡',
    'Emoji Pack': '絵文字パック',
