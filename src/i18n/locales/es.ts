export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'Mostrar a otros que esto se envió vía {{appName}}',
    ...
    Zaps: 'Zaps',
    'Enjoying {{appName}}?': '¿Te gusta {{appName}}?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      '¡Tu donación me ayuda a mantener y mejorar {{appName}}! 😊',
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} es un cliente enfocado en explorar relays. Comienza explorando relays interesantes o inicia sesión para ver tu feed de seguidos.',
    'Explore Relays': 'Explorar Relays',
    'Choose a feed': 'Elige un feed',
    'and {{x}} others': 'y {{x}} otros',
    selfZapWarning:
      '{{appName}} no se hace responsable de lo que suceda si te zapeas a ti mismo. Procede bajo tu propio riesgo. 😉⚡',
