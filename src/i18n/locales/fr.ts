export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'Montrer aux autres que cela a été envoyé via {{appName}}',
    ...
    Reactions: 'Réactions',
    Zaps: 'Zaps',
    'Enjoying {{appName}}?': 'Vous appréciez {{appName}} ?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      "Votre don m'aide à maintenir {{appName}} et à l'améliorer ! 😊",
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      "{{appName}} est un client axé sur la navigation des relais. Commencez par explorer des relais intéressants ou connectez-vous pour voir votre fil d'abonnements.",
    'Explore Relays': 'Explorer les relais',
    'Choose a feed': 'Choisir un fil',
    'and {{x}} others': 'et {{x}} autres',
    selfZapWarning:
      "{{appName}} n'est pas responsable de ce qui se passe si vous vous zappez vous-même. Procédez à vos risques et périls. 😉⚡",
