export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}': 'แสดงให้ผู้อื่นเห็นว่าส่งผ่าน {{appName}}',
    ...
    Reactions: 'ปฏิกิริยา',
    Zaps: 'ซาตส์',
    'Enjoying {{appName}}?': 'ชอบ {{appName}} ไหม?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'การบริจาคของคุณช่วยให้ฉันดูแลและพัฒนา {{appName}} ให้ดีขึ้น! 😊',
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} เป็นไคลเอนต์ที่เน้นการเรียกดูรีเลย์ เริ่มต้นด้วยการสำรวจรีเลย์ที่น่าสนใจ หรือเข้าสู่ระบบเพื่อดูฟีดที่คุณติดตาม',
    'Explore Relays': 'สำรวจรีเลย์',
    'Choose a feed': 'เลือกฟีด',
    'and {{x}} others': 'และอื่น ๆ {{x}} รายการ',
    selfZapWarning:
      '{{appName}} ไม่รับผิดชอบต่อสิ่งที่เกิดขึ้นหากคุณ zap ตัวเอง ดำเนินการด้วยความเสี่ยงของคุณเอง 😉⚡',
