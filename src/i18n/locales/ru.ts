export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'Показать другим, что сообщение отправлено через {{appName}}',
    ...
    Reactions: 'Реакции',
    Zaps: 'Запы',
    'Enjoying {{appName}}?': 'Нравится {{appName}}?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'Ваше пожертвование помогает поддерживать и улучшать {{appName}}! 😊',
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} — это клиент, ориентированный на просмотр relay. Начните с изучения интересных relay или войдите, чтобы увидеть ленту подписок.',
    'Explore Relays': 'Исследовать Relay',
    'Choose a feed': 'Выберите ленту',
    'and {{x}} others': 'и {{x}} других',
    selfZapWarning:
      '{{appName}} не несет ответственности за то, что произойдет, если вы отправите zap самому себе. Продолжайте на свой страх и риск. 😉⚡',
