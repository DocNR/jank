export default {
  translation: {
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} é um cliente focado em explorar relays. Comece por explorar relays interessantes ou inicie sessão para ver o seu feed de seguidos.',
    'Explore Relays': 'Explorar Relays',
    'Choose a feed': 'Escolha um feed',
    'and {{x}} others': 'e {{x}} outros',
    selfZapWarning:
      '{{appName}} não é responsável pelo que acontece se você zap a si mesmo. Prossiga por sua conta e risco. 😉⚡',
