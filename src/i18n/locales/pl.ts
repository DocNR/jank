export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'Pokaż innym, że zostało to wysłane przez {{appName}}',
    ...
    Reactions: 'Odzewy',
    Zaps: 'Zapy',
    'Enjoying {{appName}}?': 'Podoba ci się {{appName}}?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'Twoja darowizna pomoże mi utrzymać i ulepszać {{appName}}! 😊',
    ...
    'Welcome to {{appName}}': 'Witamy w {{appName}}',
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} to klient skupiający się na przeglądaniu transmiterów. Rozpocznij od odkrycia interesujących transmiterów lub zaloguj się, aby wyświetlić wpisy  obserwowanych użytkowników.',
    'Explore Relays': 'Przeglądaj transmitery',
    'Choose a feed': 'Wybierz transmitery',
    'and {{x}} others': 'i {{x}} innych',
    selfZapWarning:
      '{{appName}} nie ponosi odpowiedzialności za to, co się stanie, jeśli zappujesz samego siebie. Kontynuuj na własne ryzyko. 😉⚡',
