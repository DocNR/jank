export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'दूसरों को दिखाएं कि यह {{appName}} के माध्यम से भेजा गया था',
    ...
    Zaps: 'जैप्स',
    'Enjoying {{appName}}?': '{{appName}} का आनंद ले रहे हैं?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'आपका दान मुझे {{appName}} को बनाए रखने और इसे बेहतर बनाने में मदद करता है! 😊',
    ...
    'Welcome to {{appName}}': '{{appName}} में आपका स्वागत है',
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} एक क्लाइंट है जो रिले ब्राउज़ करने पर केंद्रित है। रोचक रिले की खोज करके शुरू करें या अपनी फ़ॉलोइंग फ़ीड देखने के लिए लॉगिन करें।',
    'Explore Relays': 'रिले एक्सप्लोर करें',
    'Choose a feed': 'एक फीड चुनें',
    'and {{x}} others': 'और {{x}} अन्य',
    selfZapWarning:
      '{{appName}} आपके द्वारा स्वयं को zap करने पर क्या होता है, इसके लिए जिम्मेदार नहीं है। अपनी जोखिम पर आगे बढ़ें। 😉⚡',
