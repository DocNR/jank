export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}': '告訴別人這是透過 {{appName}} 發送的',
    ...
    'Encrypted Key': '加密私鑰',
    'Private Key': '私鑰',
    'Welcome to {{appName}}': '歡迎來到 {{appName}}',
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} 是一個專注於瀏覽伺服器的客戶端。從探索有趣的伺服器開始，或者登入檢視你的關注動態。',
    'Explore Relays': '探索伺服器',
    'Choose a feed': '選擇一個動態',
    'and {{x}} others': '和其他 {{x}} 人',
    selfZapWarning: '{{appName}} 對您給自己打賞所發生的事情概不負責。風險自負。😉⚡',
    'Emoji Pack': '表情包',
