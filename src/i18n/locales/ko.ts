export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}': '이 노트가 {{appName}}을 통해 전송되었음을 표시',
    ...
    Reactions: '반응',
    Zaps: '잽',
    'Enjoying {{appName}}?': '{{appName}}이 마음에 드시나요?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      '후원해주시면 {{appName}}을 더 잘 유지하고 발전시킬 수 있습니다! 😊',
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}}은 릴레이 탐색에 중점을 둔 클라이언트입니다. 흥미로운 릴레이를 탐색하거나 로그인하여 팔로잉 피드를 확인하세요.',
    'Explore Relays': '릴레이 탐색',
    'Choose a feed': '피드 선택',
    'and {{x}} others': '및 기타 {{x}}명',
    selfZapWarning:
      '{{appName}}은 자신에게 Zap을 보낼 때 발생하는 일에 대해 책임을 지지 않습니다. 본인의 책임 하에 진행하세요. 😉⚡',
    'Emoji Pack': '이모지 팩',
