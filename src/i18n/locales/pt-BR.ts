export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'Mostrar aos outros que isso foi enviado via {{appName}}',
    ...
    Reactions: 'Reações',
    Zaps: 'Zaps',
    'Enjoying {{appName}}?': 'Gostando do {{appName}}?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'Sua doação me ajuda a manter o {{appName}} e torná-lo melhor! 😊',
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} é um cliente focado em navegar relays. Comece explorando relays interessantes ou faça login para ver o conteúdo das pessoas que você segue.',
    'Explore Relays': 'Explorar Relays',
    'Choose a feed': 'Escolha um feed',
    'and {{x}} others': 'e {{x}} outros',
    selfZapWarning:
      '{{appName}} não é responsável pelo que acontece se você zapear a si mesmo. Prossiga por sua conta e risco. 😉⚡',
