export default {
  translation: {
    ...
    'Show others this was sent via {{appName}}':
      'Anderen zeigen, dass dies über {{appName}} gesendet wurde',
    ...
    Zaps: 'Zaps',
    'Enjoying {{appName}}?': 'Gefällt dir {{appName}}?',
    'Your donation helps me maintain {{appName}} and make it better! 😊':
      'Deine Spende hilft mir, {{appName}} zu pflegen und zu verbessern! 😊',
    ...
    '{{appName}} is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      '{{appName}} ist ein Client, der sich auf das Durchsuchen von Relays konzentriert. Beginnen Sie mit der Erkundung interessanter Relays oder melden Sie sich an, um Ihren Following-Feed anzuzeigen.',
    'Explore Relays': 'Relays erkunden',
    'Choose a feed': 'Wähle einen Feed',
    'and {{x}} others': 'und {{x}} andere',
    selfZapWarning:
      '{{appName}} ist nicht verantwortlich für das, was passiert, wenn Sie sich selbst zappen. Fahren Sie auf eigene Gefahr fort. 😉⚡',
