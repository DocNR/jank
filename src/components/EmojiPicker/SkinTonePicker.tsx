      ...
      {TONES.map((tone) => {
        ...
        return (
          <button
            ...
            aria-hidden={!visible}
            className={cn(
              'hover:bg-muted flex h-9 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-md text-2xl leading-none transition-all duration-200',
              visible
