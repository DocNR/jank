  ...
  return (
    ...
    >
      ...
      {loaded && embedded && !supportTouch && (
        /* Hover overlay mask */
        <div
          className="bg-muted/40 absolute inset-0 flex cursor-pointer items-center justify-center rounded-lg opacity-0 backdrop-blur-md transition-opacity duration-200 group-hover:opacity-100"
