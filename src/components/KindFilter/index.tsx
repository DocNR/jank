  ...
  const trigger = (
    ...
    >
      ...
      {isDifferentFromDefault && (
        <div className="bg-primary ring-background absolute start-7 top-2 size-2 rounded-full ring-2" />
      )}
    </Button>
  )
...
export default memo(KindFilter, (prev, next) => {
  return (
    prev.feedId === next.feedId &&
    prev.onShowKindsChange === next.onShowKindsChange &&
    isSameKindFilter(prev.showKinds, next.showKinds)
  )
})
